...
#### 3. Advanced
+ HTTPS hoạt động ntn? Tại sao nó bảo mật hơn HTTP? - [source](https://viblo.asia/p/hieu-hon-ve-https-voi-vi-du-bo-cau-dua-thu-OeVKBojQZkW)
...
+ `Rakefile` va `config.ru` trong thư mục Rails project để làm gì?
+ Gems:
...
#### 3. Advanced
+ Rails session hoạt động ntn? - [Source](https://www.justinweiss.com/articles/how-rails-sessions-work/)
...
## Ruby
#### 1. Basic
+ OOP là gì? Áp dụng vào trong Ruby ntn?
+ Cách tạo getter và setter
+ Từ khóa `yeild` trong Ruby được dùng ntn? Liên hệ với `yield` trong file `application.html.erb` của Rails app.
